...
export default function ReviewPage() {
    ...
    // Display-only phone (UI): show as 0xx… while keeping backend normalized
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                <section className="lg:col-span-2 rounded-3xl ring-1 ring-slate-200 bg-white shadow-sm p-6">
                    ...
                    <div className="mt-6 flex justify-between">
                        <Link
                            to="/order/products"
                            className="rounded-2xl bg-brand-700 text-white px-5 py-3 font-medium hover:bg-slate-700 transition"
                        >
                            Edit products
                        </Link>
                        <button
                            onClick={() => nav("/order/payment")}
                            className="rounded-2xl bg-green-600 text-white px-5 py-3 font-medium hover:bg-slate-700 transition"
                        >
                            Go to Payment
                        </button>
                    </div>
